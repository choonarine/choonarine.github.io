...
<Callout type="error" title="임시 안내">
  해당 글은 임시용 글로, AI를 활용하여 작성되었습니다. <br /> 블로그 개발 테스트 목적으로
  작성되었으며, 이후 삭제될 예정입니다.
</Callout>
...
<Callout type="info" title="Tip">
  Closures are the foundation of the Module Pattern, which is essential for organizing code and
...
<Callout type="warning" title="Important">
  Using `var` in loops creates unexpected behavior due to function-level scope. Always use `let` or
  `const` to create block-level scope.
</Callout>
